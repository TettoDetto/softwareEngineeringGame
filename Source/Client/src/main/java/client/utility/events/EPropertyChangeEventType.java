...
public enum EPropertyChangeEventType {
	...
	PATHFINDING_INITIALIZED, SEARCHING_FOR_TREASURE, SEARCHING_FOR_CASTLE, MOVE_CALCULATED, WAITING_FOR_OPPONENT,
	...
	public String toString() {
		...
		case SEARCHING_FOR_TREASURE:
			return "[SEARCHING FOR THE TREASURE]";
		case SEARCHING_FOR_CASTLE:
			return "[SEARCHING FOR THE CASTLE]";
